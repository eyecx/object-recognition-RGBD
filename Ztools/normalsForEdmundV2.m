function [NRot, pcRot] = normalsForEdmundV2(im_i, selN)
%function [NRot, pcRot] = normalsForEdmundV2(im_i)
...
% Input: im_i is the image number.
	param.selN = selN;
	param.selG = 5;
	param.localNormalDir = 'paPbV3_34_V2';
	param.localNormalExt = 'paPbV3_34_V2';
	...
	selN = param.selN;
	selG = param.selG;
	outFileName = [c.normalsDir '/' param.localNormalDir '/img_' num2str(im_i,'%04d') '_normalsV' param.localNormalExt '.mat'];
	dt = load(outFileName);
	N = dt.N{selN};
